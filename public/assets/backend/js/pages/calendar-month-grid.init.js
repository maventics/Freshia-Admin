...
function editEvent(e) {
    ...
    ("new-event" == t
        ? ((document.getElementById("modal-title").innerHTML = ""),
          (document.getElementById("modal-title").innerHTML = "Add Appiontment"),
          (document.getElementById("btn-save-event").innerHTML = "Add Appiontment"),
          eventTyped)
        : "edit-event" == t
        ? ((e.innerHTML = "Cancel"),
